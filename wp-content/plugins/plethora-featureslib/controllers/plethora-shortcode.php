...
if ( !class_exists('Plethora_Shortcode')) {
	...
	class Plethora_Shortcode {
         ...
         */
			...
			add_action( 'vc_before_init', array( $this, 'plethora_vcSetAsTheme' ) );								
...
//// VISUAL COMPOSER METHODS START HERE
         ...
         * @since 1.0
         */
        public function plethora_vcSetAsTheme() {
        ...
        public function add( $map, $vc_options = array() ) {
			...
			$map['category'] = 'Plethora Shortcodes';	// VC EXTRAS
        ...
        public static function vc_enqueues() {
        	...
        	if( $post_types ==! null ) {
        		...
        		if( in_array( get_post_type(), $post_types ) ) {
		            ...
		            wp_enqueue_script( 'plethora-vc-admin', PLE_CORE_LIBS_URI . '/extend_vc/vc_custom.js',  array(), PLETHORA_VERSION, true);
