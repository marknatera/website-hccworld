	...
	class Plethora_Shortcode_ImageCompare extends Plethora_Shortcode { 
       ...
       */
       public function content( $atts, $content = null ) {
          ...
          // VC CSS FILTERING >>>
          $css = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, vc_shortcode_custom_css_class( $css, ' ' ), SHORTCODES_PREFIX . $this->wp_slug, $atts );
       ...
       public function init_script_twentytwenty() {
        ...
        return '
        <script>
        jQuery(function($) { "use strict"; $.fn.twentytwenty && $(\'.twentytwenty-container\') && $(\'.twentytwenty-container\').twentytwenty({ default_offset_pct: 0.5, orientation: \'horizontal\' }); });
        </script>
        ';
       }
	}
