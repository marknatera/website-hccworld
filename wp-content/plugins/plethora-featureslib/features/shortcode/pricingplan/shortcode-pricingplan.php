          ...
          $params = array(
                  ...
                  array(
                    ...
                    array(
                        ...
                        "type"          => "dropdown",
                        "heading"       => esc_html__("Title section vector background pattern", 'plethora-framework'),
                        "value"         => array( 
                   ...
                   array(
                      ...
                      "holder"        => "h5",                                               
                      "class"         => "",                                                    
                      "heading"       => esc_html__("Price amount ( larger font size text / no HTML please )", 'plethora-framework'),
                      "value"         => '',                                     
                      "admin_label"   => false,                                             
                  ),
                   array(
                      ...
                      "holder"        => "h5",                                               
                      "class"         => "",                                                    
                      "heading"       => esc_html__("Price cycle ( smaller font size text / no HTML please )", 'plethora-framework'),
                      "value"         => '',                                     
                      "admin_label"   => false,                                             
                  ),
                   array(
                   ...
                   array(
                      ...
                      "holder"        => "",                                               
                      "class"         => "",                                                    
                      "heading"       => esc_html__("Features ( add each feature on different line, may use some styling html tags )", 'plethora-framework'),
                      "value"         => '',                                     
                      "admin_label"   => false,                                             
                  ),
                    array(
       ...
       */
       public function content( $atts, $content = null ) {
          ...
          $shortcode_atts = array (
                                  ...
                                  'button_icon_align' => $button_icon_align,
