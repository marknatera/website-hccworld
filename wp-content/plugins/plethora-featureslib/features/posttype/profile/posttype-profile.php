...
if ( class_exists('Plethora_Posttype') && !class_exists('Plethora_Posttype_Profile') ) {  
	...
	class Plethora_Posttype_Profile {
		...
		public $profile_layout_content      = 'default';
		public $profile_colorset            = 'secondary_section';
		public $profile_title               = 1;
		public $profile_subtitle            = 1;
		public $profile_media_stretch       = 'stretchy_wrapper ratio_1-1';
		public $profile_authorposts         = 'sidebar-pages';
		public $profile_authorposts_heading = 'Latest Posts';
		public $profile_authorposts_num     = 5;
		public $profile_urlrewrite          = 'profile';
		...
		*/
		public function single_themeoptions( $sections ){
	    	...
	    	$sections[] = array(
				'title'      => esc_html__('Profiles', 'plethora-framework'),
				'heading'    => esc_html__('SINGLE PROFILE POSTS OPTIONS', 'plethora-framework'),
        ...
        public function single_themeoptions_global() {
        	...
        	$fields = array(
		            ...
		            array(
		                ...
		                'title'     => esc_html__( 'Profile Content Layout', 'plethora-framework' ),
		                'default'   => $this->profile_layout_content,
		                'type'      => 'image_select',
		                'options'   => array( 
					...
					array(
						...
						'default' => $this->profile_media_stretch,
					...
					array(
						...
						"default" => $this->profile_authorposts,
					),	
					array(
						...
						'default'   => $this->profile_authorposts_heading,
						'translate' => true,
						),
					array(
						...
						"default"       => $this->profile_authorposts_num,
						"min"           => 0,
						"step"          => 1,
						"max"           => 50,
						'display_value' => 'text'
					...
					array(
						...
						'default' => $this->default_user_socialicons()
					),
					array(
						...
						'default'  => $this->profile_urlrewrite,
		...
		*/
        public function single_metabox( $metaboxes ) {
		    ...
		    $metaboxes[] = array(
		        ...
		        'title'         => esc_html__( 'Profile Options', 'plethora-framework' ),
        ...
        public function single_metabox_global() {
        	...
        	$fields = array(
					...
					array(
						...
						'type'    => 'switch', 
						'title'   => esc_html__('Author Posts', 'plethora-framework'),
						'desc'    => esc_html__('Will enable author posts display on profile page. Works only if a user is selected on the previous option.', 'plethora-framework'),
					),	
					array(
						'id'       => METAOPTION_PREFIX .'profile-authorposts-heading',
						'required'      => array(METAOPTION_PREFIX .'profile-authorposts','=','1'),						
