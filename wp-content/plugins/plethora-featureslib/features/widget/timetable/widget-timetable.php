      ...
      */
      class Plethora_Widget_Timetable extends WP_Widget  {
          ...
          public function __construct() { 
            ...
            $this->enableSortable();          /* SORTABLE LIST */
          ...
          public function enableSortable(){
            ...
            function enqueueSortableScripts(){
            ...
            add_action( 'admin_enqueue_scripts', 'enqueueSortableScripts' );  
          ...
          function form( $instance ) {
            ...
            <p>
              <label for="<?php echo esc_attr( $this->get_field_id('button_text') ); ?>"><?php esc_html__('Button Text (leave empty to remain hidden):', 'plethora-framework'); ?></label>
              <input class="widefat" id="<?php echo esc_attr( $this->get_field_id('button_text') ); ?>" name="<?php echo esc_attr( $this->get_field_name('button_text') ); ?>" type="text" value="<?php echo esc_attr( $button_text ); ?>" />
            </p>

            <p>
              <label for="<?php echo esc_attr( $this->get_field_id('button_link') ); ?>"><?php esc_html__('Button Link:', 'plethora-framework'); ?></label>
            ...
            <p>
              <label for="<?php echo esc_attr( $this->get_field_id('button_align') ); ?>"><?php esc_html__('Button Align: left, center, right (Default: center)', 'plethora-framework'); ?></label>
            ...
            <p>
              <label for="<?php echo esc_attr( $this->get_field_id('button_icon') ); ?>"><?php esc_html__('Button Icon (FontAwesome):', 'plethora-framework'); ?></label>
            ...
            <p>
              ...
              <input type="button" name="widgetTimetableAddRow" value="<?php esc_attr__('Add Row', 'plethora-framework'); ?>" class="widgetTimetableAddRow" class="button" />
            ...
            <script id="widgetTimetableTemplate" type="text/html">
                ...
                <button class="button button-small"><?php esc_html__('REMOVE', 'plethora-framework'); ?></button>
            </script>
            <!-- /DRAG AND DROP SORTABLE WORKTABLE LIST -->
  <?php  }
     }
