		...
		public function theme_sidebars(){
		    ...
		    if ( isset( $sidebars['sidebar_slug'] ) ) { 
			    foreach ($sidebars['sidebar_slug'] as $key => $sidebar_slug ) {
			     if ( !empty($sidebar_slug) && !empty( $sidebars['sidebar_name'][$key] ) ) { 

			          $sidebar = array(
			              'name'          => $sidebars['sidebar_name'][$key],
			              'id'            => $sidebars['sidebar_slug'][$key],
			              'description'   => $sidebars['sidebar_desc'][$key],
			              'class'         => $sidebars['sidebar_class'][$key],
